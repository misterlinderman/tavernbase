...
export async function computePoolDivisionStandings(
  leagueId: mongoose.Types.ObjectId,
  divisionId: mongoose.Types.ObjectId
): Promise<ComputedStandingsEntry[]> {
  // TODO: apply handicapRules in v1.1
...
export const poolStandingsEngine = {
  sport: 'pool' as const,
  computeDivisionStandings: computePoolDivisionStandings,
};
